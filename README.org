...
#+begin_src gnuplot :var data=fulgurhub-confronto :file fulgurhub_confronto.png
reset
...
#+CAPTION: FulgurHub a confronto con tecnologie alternative
#+LABEL: fulgurhub_confronto_chart
#+ATTR_HTML: :width 100% :placement [!htb]
#+RESULTS:
